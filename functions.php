...
function custom_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Portfolio Works', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Portfolio Work', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Portfolio Works', 'text_domain' ),
		'name_admin_bar'        => __( 'Portfolio Work', 'text_domain' ),
		...
		'items_list'            => __( 'workss list', 'text_domain' ),
